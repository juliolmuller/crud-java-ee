...
public class FuncionarioFilter implements Filter {
    ...
    public void doFilter(
        ...
        String roleRequired = "funcionario";
        User funcionario = (User) request.getSession().getAttribute("userCredentials");
        if (funcionario == null || !funcionario.getRole().equals(roleRequired)) {
